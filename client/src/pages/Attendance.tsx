          ...
          <Card className="border-none shadow-lg shadow-slate-200/50 overflow-hidden">
            <div className="bg-indigo-600 p-6 text-white">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-medium text-indigo-100 uppercase tracking-wider">Current Time</span>
              </div>
              ...
              {todayRecord && (
                <div className="mt-6 p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-3">
                  ...
                  <div className="pt-2 flex justify-center">
                    <Badge className={todayRecord.checkOut ? 'bg-slate-200 text-slate-700' : 'bg-emerald-100 text-emerald-700'}>
